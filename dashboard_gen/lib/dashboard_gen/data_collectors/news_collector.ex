defmodule DashboardGen.DataCollectors.NewsCollector do
  ...
  # Collect every hour
  @collection_interval :timer.hours(1)
  @default_companies [
    "BlackRock",
    "Vanguard",
    "State Street",
  ...
  def init(opts) do
    ...
    enabled_sources =
      Keyword.get(
        opts,
        :sources,
        [:newsapi, :google_news, :yahoo_finance, :reuters_business, :reuters_technology, :ft_news]
      )
  ...
  defp collect_from_news_source(:reuters_business, companies) do
    RSSClient.collect_reuters_business(companies)
  end
  ...
  defp collect_from_news_source(:reuters_technology, companies) do
    RSSClient.collect_reuters_technology(companies)
  end

  defp collect_from_news_source(:ft_news, companies) do
    RSSClient.collect_ft_news(companies)
  end
  ...
  defp merge_stats(old_stats, new_stats) do
    %{
      ...
      by_source:
        Map.merge(old_stats.by_source || %{}, new_stats.by_source || %{}, fn _k, v1, v2 ->
          v1 + v2
        end)
    }
  end
