    ...
    >
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <nav class="p-2 space-y-1">
          ...
          <Phoenix.Component.link navigate={~p"/ai-insights"} class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 border-l-2 border-transparent hover:text-brandBlue hover:border-brandBlue rounded-md">
            <i class="fa-solid fa-wand-magic-sparkles"></i> <span :if={!@collapsed}>AI Insights</span>
          </Phoenix.Component.link>
